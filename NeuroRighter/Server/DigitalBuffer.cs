...
namespace NeuroRighter.Server
{
    ...
    public class DigitalBuffer : NROutBuffer<DigitalOutEvent>
    {
        ...
        /// <summary>
        /// Get the current time in miliseconds, as measured by the number of samples generated by the analog buffer associated with this digital buffer
        /// </summary>
        ...
        /// <summary>
        /// Gets the current sample that the analog buffer associated with this digital buffer has output
        /// </summary>
        /// <returns></returns>
