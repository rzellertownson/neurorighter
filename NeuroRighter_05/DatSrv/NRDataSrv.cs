...
namespace NeuroRighter.DatSrv
{
    class NRDataSrv
    {
        ...
        internal RawDataSrv salpaElectrodeSrv;
        internal RawDataSrv filteredElectrodeSrv;
        internal RawDataSrv lfpSrv;
        internal RawDataSrv eegSrv;
        internal RawDataSrv auxAnalogSrv;

        // Event Data buffers
        internal EventDataSrv<SpikeEvent> spikeSrv;
        internal EventDataSrv<DigitalPortEvent> auxDigitalSrv;
        internal EventDataSrv<ElectricalStimEvent> stimSrv;
        ...
        public NRDataSrv(double bufferSizeSeconds, bool salpaAccess, bool spikeFiltAccess)
        {
            ...
            rawElectrodeSrv = new RawDataSrv(
                ...
                bufferSizeSeconds,
                Convert.ToInt32(Properties.Settings.Default.DAQRefreshPeriodSec * Properties.Settings.Default.RawSampleFrequency)
                );
            ...
            if (Properties.Settings.Default.UseLFPs)
            {
                lfpSrv = new RawDataSrv(
                    ...
                    Convert.ToInt32(Properties.Settings.Default.DefaultNumChannels),
                    bufferSizeSeconds,
                    Convert.ToInt32(Properties.Settings.Default.DAQRefreshPeriodSec * Properties.Settings.Default.LFPSampleFrequency)
                    );
            }
            ...
            if (Properties.Settings.Default.UseEEG)
            {
                eegSrv = new RawDataSrv(
                    ...
                    Convert.ToInt32(Properties.Settings.Default.DefaultNumChannels),
                    bufferSizeSeconds,
                    Convert.ToInt32(Properties.Settings.Default.DAQRefreshPeriodSec * Properties.Settings.Default.EEGSamplingRate)
                    );
            }
