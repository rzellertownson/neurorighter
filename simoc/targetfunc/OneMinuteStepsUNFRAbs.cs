...
namespace simoc.targetfunc
{
    class OneMinuteStepsUNFRAbs : TargetFunc
    {
        ...
        internal override void GetTargetValue(ref double currentTargetValue, PersistentSimocVar simocVariableStorage)
        {
            ...
            {
                currentTargetValue = muliplierTargets[0];
            }
            // Step 2
            ...
            {
                currentTargetValue = muliplierTargets[1];
            }
            // Step 3
            ...
            {
                currentTargetValue = muliplierTargets[2];
            }
            // Step 4
            ...
            {
                currentTargetValue = muliplierTargets[3];
            }
            // Step 5
            ...
            {
                currentTargetValue = muliplierTargets[4];
            }
            // Step 6
            ...
            {
                currentTargetValue = muliplierTargets[5];
            }
            // Step 7
            ...
            {
                currentTargetValue = muliplierTargets[6];
            }
            // Step 8
            ...
            {
                currentTargetValue = muliplierTargets[7];
            }
            // Step 9
            ...
            {
                currentTargetValue = muliplierTargets[8];
            }
            // Step 10
            ...
            {
                currentTargetValue = muliplierTargets[9];
            }
