...
namespace NeuroRighter.Server
{
    ...
    public abstract class NROutBuffer<T> where T : NREvent
    {
        ...
        internal void Setup(Task buffLoadTask, Logger debugger, Task masterTask)
        {
        ...
        /// </summary>
        /// <param name="analogTasks">array of analog tasks to configure</param>
        /// <param name="digitalTasks">array of digital tasks to configure</param>
        ...
        /// </summary>
        /// <param name="stim">the stimulus used by the subclass</param>
        /// <param name="anEventValues">analog values generated by the stimulus</param>
        /// <param name="digEventValues">digital values generated by the stimulus</param>
        ...
        /// <summary>
        /// clears the queue and restarts the buffer- used to recover the buffer from a failure
        /// </summary>
        ...
        /// <summary>
        /// clear the Queue of all events previously written to it
        /// </summary>
