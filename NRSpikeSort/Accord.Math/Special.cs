...
namespace Accord.Math
{
    ...
    public static class Special
    {
        ...
        /// <summary>Log of two.</summary>
        public const double Log2 = 0.69314718055994530941;

        /// <summary>Log of twice number PI.</summary>
        public const double Log2PI = 1.837877066409345483556;

        /// <summary>Square root of twice number PI.</summary>
        public const double Sqrt2PI = 2.50662827463100050242E0;

        /// <summary>Square root of half number PI.</summary>
        public const double SqrtHPI = 1.25331413731550025121E0;
