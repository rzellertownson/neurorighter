/*
 React to spikes from particular units in real-time. 
...
void setup()
{
  ...
  Serial.begin(9600);
  pinMode(2, OUTPUT);  // first bit
  pinMode(3, OUTPUT);  // second bit
...
void loop()
{
  ...
  if (Serial.available() > 0) {
    ...
    if (inByte == 1)
    {
      //Serial.print("I detected unit 1. \n");
      digitalWrite(2,HIGH);
      digitalWrite(3,LOW);
