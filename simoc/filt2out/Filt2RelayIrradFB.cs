...
{
    class Filt2RelayIrradFB : Filt2Out
    {
        ...
        public Filt2RelayIrradFB(ref NRStimSrv stimSrv, ControlPanel cp)
            : base(ref stimSrv, cp)
        {
        ...
        internal override void SendFeedBack(PersistentSimocVar simocVariableStorage)
        {
            ...
            // What is LED control signal?
            pulseWidthSamples = (ulong)(stimSrv.sampleFrequencyHz * (stimPulseWidthMSec / 1000));
            stimPowerVolts = simocVariableStorage.GenericDouble1;
            ...
            if (stimFreqHz != 0)
                ...
                isi = (ulong)(hardwareSampFreqHz / 1); ;
