...
namespace NeuroRighter.Server
{
        ...
        internal void grabPartner(DigitalBuffer digBuffer)
    {
        ...
        /// <summary>
        /// method used privately to configure tasks.  User should not extend
        /// </summary>
        /// <param name="analogTasks"></param>
        /// <param name="digitalTasks"></param>
        ...
        /// <summary>
        /// specifies how to turn this NREvent into analog and digital streams
        ...
        /// </summary>
        /// <param name="stim">the AuxOutEvent used to generate the output values</param>
