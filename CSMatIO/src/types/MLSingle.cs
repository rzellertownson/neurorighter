...
namespace csmatio.types
{
    ...
    public class MLSingle : MLNumericArray<double>
    {
        /// <summary>
        ...
        public MLSingle(string Name, float[] vals, int m)
            :
            base(Name, MLArray.mxSINGLE_CLASS, FloatToDouble(vals), m) { }
        ...
        public MLSingle(string Name, float[] Real, float[] Imag, int M)
            :
            base(Name, MLArray.mxSINGLE_CLASS, FloatToDouble(Real), FloatToDouble(Imag), M) { }
        ...
        private static double[] FloatToDouble(float[] dd)
        {
