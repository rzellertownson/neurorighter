...
{
    class Filt2IBangBangFB2 : Filt2Out
    {
        ...
        public Filt2IBangBangFB2(ref NRStimSrv stimSrv, ControlPanel cp)
            : base(ref stimSrv, cp)
        {
        ...
        internal override void SendFeedBack(PersistentSimocVar simocVariableStorage)
        {
            ...
            stimPulseWidthMSec = maxStimPulseWidthMSec;
